...
export class DataService {
  ...
  // FACTURE SERVICE SIDE //

  createFacture(contratForm: any): Observable<any> {
    return this._http.post(this.backend + '/facture/facture', contratForm)
  }
  getallFacture(): Observable<any> {
    return this._http.get(this.backend + '/facture/allfacture')
  }
  getOneFacture(id: any): Observable<any> {
    return this._http.get(this.backend + '/facture/facture/' + id)
  }
  deleteFacture(id: any): Observable<any> {
    return this._http.delete(this.backend + '/facture/delete/' + id)
  }
  getallFactureByEnt(): Observable<any> {
    return this._http.get(this.backend + '/facture/facturebyent')
  }
  updateFacture(value: any, id: number): Observable<any> {
    return this._http.put<any>(this.backend + "/facture/update/" + id, { formulaire: value })
  }
